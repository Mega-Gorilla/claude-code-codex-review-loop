...
REPRESENTATIVE: dict[SchemaKind, dict[str, object]] = {
    ...
    SchemaKind.USER_REQUEST: {
        ...
        "since_seq": 3,
        "accepted_result_kinds": ["GATE_QUESTION", "MERGE_APPROVAL"],
        "verified_records": [{"comment_id": "c-1", "head_sha": SHA}],
    },
    SchemaKind.USER_SUBMIT: {
        "schema_version": 1,
        "run_id": "run-1",
        "request_id": "req-1",
        "awaiting": "USER_INPUT_GATE",
        ...
        "nonce": "nonce-1",
        "result_hash": "rh-1",
        "result_kind": "GATE_QUESTION",
    },
    SchemaKind.PERMISSION_RESUME: {
        "schema_version": 1,
    ...
    SchemaKind.SESSION_CONFIG: {
        ...
        "retry_max_wait_ms": 5_000,
        "search_since": None,
        "search_attempts": 3,
        "search_backoff_ms": 200,
        "search_max_pages": 5,
        "detection_head": SHA,
        "producer_logins": ["controller"],
